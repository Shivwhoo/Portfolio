      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            {/* 2. Resume Hover Action */}
            <div className="relative group flex-1 sm:flex-none">
              <button
                className="w-full px-6 py-3.5 md:px-8 md:py-4 rounded-lg border border-indigo-500/50 hover:bg-indigo-500/10 text-indigo-400 font-bold tracking-widest uppercase transition-all duration-300 flex justify-center items-center text-xs md:text-sm gap-2 shadow-[0_0_15px_rgba(99,102,241,0.1)] hover:shadow-[0_0_25px_rgba(99,102,241,0.3)] cursor-pointer"
              >
                <svg
                  className="w-4 h-4 md:w-5 md:h-5 transition-transform duration-300 group-hover:rotate-180"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              {/* Dropdown Menu */}
              <div className="absolute top-full left-0 pt-2 w-full min-w-[200px] opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-300 z-50">
                <div className="bg-[#121214]/95 backdrop-blur-xl border border-indigo-500/30 rounded-lg shadow-[0_10px_30px_rgba(0,0,0,0.5)] py-1.5">
                  <a
                    href="/Shivam%20Kishore%20CV-MAY.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 px-4 py-3 text-xs md:text-sm text-zinc-300 hover:text-white hover:bg-indigo-500/20 font-bold tracking-wider uppercase transition-all duration-200 border-b border-zinc-800/50 cursor-pointer"
                  >
                    <svg
                  ...
                  <a
                    href="/Shivam%20Kishore%20CV-MAY.pdf"
                    download="Shivam_Kishore_CV.pdf"
                    className="flex items-center gap-3 px-4 py-3 text-xs md:text-sm text-zinc-300 hover:text-white hover:bg-indigo-500/20 font-bold tracking-wider uppercase transition-all duration-200 cursor-pointer"
                  >
                    <svg
                      className="w-4 h-4 text-indigo-400"
                      fill="none"
